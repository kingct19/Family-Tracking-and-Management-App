...
import { MdLocationOn, MdPeople, MdCheckCircle, MdFlashOn, MdTaskAlt, MdMessage, MdStar, MdSecurity } from 'react-icons/md';
...
const RegisterPage = () => {
    ...
    useEffect(() => {
        // Load from local public folder - file name has a space, so we need to encode it
        fetch('/Sign%20up.json')
            .then(res => {
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col safe-top safe-bottom">
                ...
                <div className="flex-1 flex items-center justify-center px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8">
                    ...
                    {/* Left side - Lottie Animation with Feature Carousel */}
                    <div className="hidden lg:flex items-stretch order-1">
                        <div className="relative w-full flex flex-col">
                            {/* Lottie Animation Container with warm gradient background */}
                            <div className="relative bg-gradient-to-br from-amber-50 via-purple-50/80 to-pink-50 rounded-2xl lg:rounded-l-2xl lg:rounded-r-none p-8 sm:p-10 md:p-12 shadow-lg h-full flex flex-col">
                                {/* Lottie Animation */}
                                <div className="flex-1 flex items-center justify-center overflow-hidden mb-6">
                                    {animationData && !hasError ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center">
                                            <div className="w-48 h-48 bg-gradient-to-br from-amber-200 to-purple-200 rounded-full flex items-center justify-center animate-pulse">
                                                <MdPeople size={64} className="text-purple-600" />
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="relative mt-auto">
                                    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-purple-100/50 shadow-sm">
                                        ...
                                        <div className="flex items-start gap-4 mb-4">
                                            <div className="w-12 h-12 bg-gradient-to-br from-amber-100 to-purple-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                                {(() => {
                    ...
                    <div className="w-full max-w-md mx-auto lg:max-w-none order-2">
                        <div className="bg-white rounded-2xl lg:rounded-l-none lg:rounded-r-2xl p-8 sm:p-10 md:p-12 shadow-lg h-full flex flex-col">
