...
const TestStylingPage = () => {
    return (
        <>
            <Helmet>
                <title>Test Styling - Family Tracker</title>
            </Helmet>

            <div className="min-h-screen bg-red-500 p-8">
                <h1 className="text-4xl font-bold text-white mb-4">Styling Test</h1>
                <p className="text-white text-lg mb-4">If you can see red background and white text, Tailwind is working!</p>
